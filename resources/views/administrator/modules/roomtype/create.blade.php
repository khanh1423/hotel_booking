        ...
        <div class="card mb-4">
            ...
            <form action="{{route('admin.roomtype.store')}}" method="POST">
                ...
                {{-- <div class="row"> --}}
                    ...
                    <input type="text" class="form-control" name="roomtype_name" value="{{ old('roomtype_name') }}" id="basic-default-fullname" placeholder="ví dụ: phòng tổng thống,..." />
